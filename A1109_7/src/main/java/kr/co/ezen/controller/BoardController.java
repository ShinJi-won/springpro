...
import kr.co.ezen.entity.PageMaker;
...
public class BoardController {
	...
	public String getList(Criteria cri, Model model) {//type,keyword
		...
		//pageMaker.setTotalCount(전체페이지의수);
	...
	public String remove(int idx, Criteria cri, RedirectAttributes rttr) {
		...
		rttr.addAttribute("page",cri.getPage());
		rttr.addAttribute("perPageNum",cri.getPerPageNum()); //page=2&perPageNum=4
		rttr.addAttribute("type",cri.getType());
		rttr.addAttribute("keyword",cri.getKeyword());
		return "redirect:/board/list";
	}
